...
class Model(nn.Module):
    def __init__(self, args, num_layers=1):
        ...
        self.gru = nn.GRU(self.in_var, self.hidden_dims, num_layers, batch_first=True, bidirectional=True)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        gru_input = torch.cat((gru_out[:, -1, :self.hidden_dims], gru_out[:, 0, self.hidden_dims:]), dim=1)
